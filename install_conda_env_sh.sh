#!/bin/bash
set -e
export CONDA_ENV_NAME='ds'
export PIP_PACKAGES="numpy scipy xlrd xlsxwriter pandas scikit-learn statsmodels matplotlib seaborn google-api-python-client google-cloud-storage google-cloud-bigquery"
